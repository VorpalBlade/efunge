...
%% API - Non-calls
-export([load_initial/2, set/3, set/4, load/5, save/6,
...
%%====================================================================
%% Internal functions - Client - Writing to file
%%====================================================================
...
-spec load_initial(binary(),fungespace(),integer(),integer(),boolean()) -> ok.
